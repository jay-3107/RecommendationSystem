...
const ProductCard = ({ product, recommendedProducts = [] }) => {
  ...
  return (
    <>
      <Card className="border rounded-lg shadow-md w-full sm:w-80 md:w-64 lg:w-80 transition-transform hover:scale-y-105.">
        ...
        <CardFooter className="flex justify-center mt-4">
          <Button className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all" onClick={() => setShowPopup(true)}>
            Add to Cart
          </Button>
        </CardFooter>
      </Card>
