              ...
              {!showForm ? (
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col items-center text-center">
                    <h1 className="text-2xl font-bold">Hi Welcome to ShopVerse</h1>
                    <p className="text-balance text-muted-foreground">
                      Sign Up to your ShopVerse account
                    </p>
                  </div>
                  ...
                  <div className="relative text-center text-sm">
                    ...
                    <div className="absolute inset-0 top-1/2 z-0 flex items-center border-t border-border"></div>
                  </div>
